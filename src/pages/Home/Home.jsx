...
import IITHMap from '../../components/IITHMap/IITHMap';
...
import artemis from '../../assets/Merch/artemis.png';
import expedition from '../../assets/Merch/expedition.png';
import spaceship_orange from '../../assets/Merch/spaceship orange.png';
import starchild from '../../assets/Merch/starchild.png';
...
import img9 from '../../assets/Home/gallery/9.jpg';
import img10 from '../../assets/Home/gallery/10.jpg';
import img11 from '../../assets/Home/gallery/11.jpg';
import img12 from '../../assets/Home/gallery/12.jpg';
import img13 from '../../assets/Home/gallery/13.jpg';
import img14 from '../../assets/Home/gallery/14.jpg';
import img15 from '../../assets/Home/gallery/15.jpg';
import img16 from '../../assets/Home/gallery/16.jpg';
import img17 from '../../assets/Home/gallery/17.jpg';
import img18 from '../../assets/Home/gallery/18.jpg';
import img19 from '../../assets/Home/gallery/19.jpg';
import img20 from '../../assets/Home/gallery/20.jpg';
import img21 from '../../assets/Home/gallery/21.jpg';
    ...
    <>
      <div className='Home'>
        ...
        <div className='Home-Hero'>
          ...
          <div className='Home-Hero-Headings'>
            ...
            <div className='Home-Hero-Description'>
              ...
              edition, ‘A Space Odyssey’. From 21 to 23 February, IIT Hyderabad shall transform into a
              vibrant civilization of innovation. Witness electrifying performances, engage in cutting-edge
              competitions, and immerse yourself in a universe where technology, creativity, and human
              potential collide. Your odyssey awaits, are you ready to explore?
        ...
        <div className='Home-Theme'>
          <div className='Home-Theme-Heading'>THEME</div>
          <div className="Home-Theme-svg">
            <svg viewBox="0 0 1320 571" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g style={{ mixBlendMode: 'plus-lighter' }}>
                <path d="M434.053 177.708C424.955 177.708 422.185 174.036 427.003 166.741L453.424 126.645H500.157L506.486 166.724C507.644 174.036 503.044 177.708 493.963 177.708L493.443 180.14H534.519L534.955 177.725C532.89 177.725 524.178 176.618 522.298 166.322L503.078 60.6406H476.556L476.069 62.6362C477.949 62.6362 489.464 62.6865 483.321 71.893L420.624 166.305C413.104 177.641 404.644 177.725 402.579 177.725L401.891 180.14H433.432L434.053 177.708ZM491.143 69.4446L499.419 121.883H456.58L491.143 69.4446Z" fill="#F1ECE5"/>
                <path d="M677.489 147.557C678.68 130.016 657.731 118.546 639.25 110.144C622.917 102.716 608.631 95.6388 610.243 82.9946C611.854 70.3505 625.737 64.8669 638.964 64.8669C656.707 64.8669 668.827 75.6161 671.412 90.0043H673.913L673.191 70.2666C664.278 63.2067 651.487 60.6074 639.417 60.6074C616.42 60.6074 599.063 69.7971 596.764 86.315C594.867 99.9486 611.586 109.524 628.523 117.691C646.82 126.511 664.328 136.422 662.784 154.818C661.307 172.191 641.449 178.262 626.895 178.262C605.526 178.262 593.205 163.639 590.2 136.892H587.598L586.205 168.536C597.217 178.463 610.763 183.477 626.341 183.477C650.328 183.477 675.793 172.695 677.489 147.557Z" fill="#F1ECE5"/>
                <path d="M723.633 179.2H717.422C715.358 179.2 707.082 179.201 707.552 167.998L709.818 115.275H737.75C759.371 115.275 779.531 107.041 779.263 88.2764C778.994 69.7629 759.489 62.1328 738.825 62.1328H689.91L689.792 64.1284C691.672 64.1284 699.209 64.1284 698.706 73.5696L693.603 168.015C692.998 179.217 684.723 179.217 682.641 179.217L682.49 181.632H723.549L723.616 179.217L723.633 179.2ZM711.917 66.409H734.192C755.225 66.409 766.119 73.7876 766.17 88.2429C766.22 102.547 754.637 110.58 733.134 110.58H710.02L711.917 66.409Z" fill="#F1ECE5"/>
                <path d="M778.775 167.776L814.63 73.3637H814.614C818.122 64.1572 806.607 64.1069 804.727 64.1069L804.659 62.1113H831.182L880.449 167.793C885.25 178.089 894.281 179.196 896.346 179.196L896.598 181.611H855.522L855.354 179.179C864.435 179.179 867.977 175.506 864.754 168.195L844.93 123.353L821.748 70.9153L800.312 128.116L785.288 168.212C782.552 175.506 786.362 179.179 795.461 179.179L795.528 181.611H763.986V179.196C766.051 179.196 774.478 179.112 778.775 167.776Z" fill="#F1ECE5"/>
                <path d="M884.242 118.962C887.7 153.642 915.683 183.491 957.43 183.491C978.245 183.491 992.631 178.746 1002.55 168.516L999.497 136.906H996.895C999.396 163.871 984.137 178.276 956.641 178.276C921.726 178.276 900.894 148.292 897.655 118.962C894.583 91.1419 907.71 64.8809 939.486 64.8809C957.85 64.8809 979.487 74.4898 986.588 91.7959H989.089L981.485 73.0979C969.584 64.9647 954.745 60.5879 938.831 60.5879C901.062 60.5879 880.969 86.1278 884.242 118.962Z" fill="#F1ECE5"/>
                <path d="M1006.41 73.5528L1025.95 167.998C1028.27 179.2 1019.99 179.2 1017.93 179.2L1018.42 181.615H1111.26L1103.29 136.908H1100.69C1103.29 151.162 1106.49 176.434 1086.38 176.434H1041.77L1028.44 115.275H1070.92C1083.77 115.275 1084.17 120.289 1085.12 123.694H1087.69L1082.05 102.346H1079.52C1080.36 105.683 1082.54 110.597 1069.73 110.597H1027.41L1017.8 66.4258H1064.24C1076.26 66.4258 1080.96 75.3304 1083.51 80.4786H1086L1076.93 62.1328H994.664L995.067 64.1284C996.947 64.1284 1004.48 64.1284 1006.45 73.5696L1006.41 73.5528Z" fill="#F1ECE5"/>
                <path d="M201.295 123.428C114.745 123.428 40.3147 193.189 11.3752 283.643C-19.545 380.286 12.332 464.284 109.927 464.284C207.522 464.284 284.42 380.269 305.319 283.643C324.875 193.172 287.844 123.428 201.295 123.428ZM301.122 277.271C279.821 375.875 215.647 430.628 135.039 441.561C46.0556 453.635 -0.391958 370.14 22.7395 289.16C47.1299 203.77 118.857 125.641 196.41 125.641C299.192 125.641 317.741 200.265 301.105 277.288L301.122 277.271Z" fill="#F1ECE5"/>
                ...
                <path d="M1085.27 0C1099.41 24.081 1098.84 25.02 1059.05 26.3784C1100.3 27.4181 1102.13 28.4242 1144.33 91.4439C1105.11 28.4242 1105.63 27.4013 1149.73 25.9759C1104.02 24.9865 1102.23 24.0642 1085.27 0Z" fill="#F1ECE5"/>
                <path d="M1079.72 28.543C1085.79 46.4192 1085.42 47.0062 1065.25 47.3583C1085.99 48.4986 1086.8 49.1359 1098.26 77.4763C1088.26 49.1694 1088.61 48.549 1109.86 48.2136C1088.03 47.0565 1087.22 46.4528 1079.73 28.543H1079.72Z" fill="#F1ECE5"/>
                <path d="M851.12 124.868C825.152 126.142 824.43 127.182 823.541 172.879C822.651 127.182 821.929 126.142 795.961 124.868C821.946 123.61 822.668 122.604 823.541 91.4297C824.414 122.587 825.135 123.594 851.12 124.868Z" fill="#F1ECE5"/>
              </g>
            </svg>
          </div>
          <div className="Home-Theme-Description">
            In the vast, empty universe, weary travellers drift, searching for meaning amid barren worlds.
            Their mission: to find a spark of life, a hint of civilization that might break the monotonous
            silence of cosmic isolation. Suddenly, a wormhole appears—a cosmic doorway shimmering with
            possibility. <br/><br/>
            On the other side: revelation. <br/><br/>
            A vibrant civilization pulses with energy and creativity bursting from every technological marvel.
            Life—complex, dynamic, interconnected—sprawls before their astonished eyes. What seemed
            impossible becomes real: connection, innovation, community. <br/><br/>
            Just like Elan & nVision, this journey represents transformation. We invite you to traverse your
            wormhole of discovery—where technology meets imagination, where science embraces art, and
            where seemingly empty spaces become portals to extraordinary experiences.
          </div>

        </div>

        <div className='Home-Events'>
          <div className='Home-Events-Heading'>EVENTS</div>
          <div className="Home-Events-Description-Container">
            <div className="Home-Events-Description">
            Elan & nVision 2025 brings an extraordinary lineup of over 30 cultural and technical
competitions. From Group Dance and Cosplay to Drone Racing, Hackathons, and E-sports,
the festival offers something for everyone. With a massive prize pool exceeding ₹6 lakhs,
exciting artist performances, movie screenings, and diverse gaming zones, participants can
look forward to an action-packed three-day experience at IIT Hyderabad.
            </div>
        ...
        <div className='Home-Gallery'>
          ...
          <div className="Home-Gallery-Grid">
            ...
            <div className="Home-Gallery-Grid-Item Home-Gallery-Grid-Item-5">
              <img src={img1} alt="f" />
            </div>
            <div className="Home-Gallery-Grid-Item Home-Gallery-Grid-Item-6">
              <img src={img1} alt="f" />
            </div>
            <div className="Home-Gallery-Grid-Item Home-Gallery-Grid-Item-7">
              <img src={img1} alt="f" />
            </div>
            <div className="Home-Gallery-Grid-Item Home-Gallery-Grid-Item-8">
              <img src={img1} alt="f" />
            </div>
            <div className="Home-Gallery-Grid-Item Home-Gallery-Grid-Item-9">
              <img src={img1} alt="f" />
            </div>
            <div className="Home-Gallery-Grid-Item Home-Gallery-Grid-Item-10">
              <img src={img5} alt="f" />
            </div>
            <div className="Home-Gallery-Grid-Item Home-Gallery-Grid-Item-11">
              <img src={img4} alt="f" />
            </div>
            <div className="Home-Gallery-Grid-Item Home-Gallery-Grid-Item-12">
              <img src={img6} alt="f" />
            </div>
            <div className="Home-Gallery-Grid-Item Home-Gallery-Grid-Item-13">
              <img src={img1} alt="f" />
            </div>
            <div className="Home-Gallery-Grid-Item Home-Gallery-Grid-Item-14">
              <img src={img1} alt="f" />
            </div>
            ...
            <div className="Home-Gallery-Grid-Item Home-Gallery-Grid-Item-18">
              <img src={img1} alt="f" />
            </div>
            <div className="Home-Gallery-Grid-Item Home-Gallery-Grid-Item-19">
              <img src={img22} alt="f" />
            </div>
            <div className="Home-Gallery-Grid-Item Home-Gallery-Grid-Item-20">
              <img src={img1} alt="f" />
            </div>
            <div className="Home-Gallery-Grid-Item Home-Gallery-Grid-Item-21">
              <img src={img1} alt="f" />
            </div>
            <div className="Home-Gallery-Grid-Item Home-Gallery-Grid-Item-22">
              <img src={img1} alt="f" />
            </div>
            <div className="Home-Gallery-Grid-Item Home-Gallery-Grid-Item-23">
              <img src={img1} alt="f" />
            </div>
        ...
        <div className='Home-Accomodation'>
          <div className='Home-Accomodation-Heading'>ACCOMODATION</div>
          <div className="Home-Accomodation-Description-Container">
            <div className="Home-Accomodation-Description">
        ...
        <div className='Home-Merch'>
          <div className='Home-Merch-Heading'>MERCH</div>
          <div className="Home-Merch-Img-Container">
            <div className="Home-Merch-Img-Box">
              <MerchContainer
        ...
        <div className='Home-Partners'>
          <div className='Home-Partners-Heading'>PARTNERS</div>
